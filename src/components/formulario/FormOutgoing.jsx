...
import { getForm, getUnis, updateForm } from "@/lib/form";
...
export default function Formulario() {
  ...
  useEffect(() => {
    const callForm = async () => {
      ...
      await updateForm("studentType", "outgoing");
    };
        ...
        {page === 1 && (
          <div className="space-y-6 w-full">
            ...
            <InputField
              ...
              register={register}
              required
              defaultValue={formData.nombreApellidos || ""}
            />
            <InputField
              label="DNI/NIE*"
              name="dniNie"
        ...
        {page === 2 && (
          <div className="space-y-6 w-full">
            ...
            <RadioGroup
              ...
              options={["Sí", "No"]}
              register={register}
              defaultValue={formData.primeraMovilidad}
            />
            <RadioGroup
              ...
              register={register}
              defaultValue={formData.semestreIntercambio}
            />
            <SelectField
        ...
        {page === 3 && (
          <div className="space-y-6 w-full">
            ...
            <RadioGroup
              ...
              options={["Sí", "No"]}
              register={register}
              defaultValue={formData.examenCertificado}
            />
            <InputField
              ...
              register={register}
              type="url"
              defaultValue={formData.linkPortfolio || ""}
            />
          </div>
        )}
        ...
        {page === 4 && (
          <div className="space-y-6 w-full">
            ...
            <RadioGroup
              ...
              options={["Sí", "No"]}
              register={register}
              defaultValue={formData.politicaDatos}
            />
          </div>
        )}
