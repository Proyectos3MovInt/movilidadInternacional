...
export default function Login() {
  ...
  return (
    <div className="w-full h-screen bg-cover bg-center bg-no-repeat flex items-center justify-center relative font-[Montserrat]" style={{ backgroundImage: "url('/fondo1.jpg')" }}>
      ...
      <form className="relative bg-white rounded-[40px] flex flex-col p-0 w-[540px] h-[480px] shadow-lg font-[Montserrat] items-start" onSubmit={handleSubmit}>
        <div className="absolute top-[40px] left-[40px]">
          <img src="/logoblanco.jpg" alt="Logo" className="w-[186px] h-[55px]" />
        </div>
        <div className="flex flex-col items-center w-full mt-[120px] gap-[25px]">
