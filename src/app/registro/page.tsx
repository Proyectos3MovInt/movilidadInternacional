...
export default function Register() {
  ...
  return (
    <div className="w-full h-screen bg-cover bg-center bg-no-repeat flex items-center justify-center relative font-[Montserrat]" style={{ backgroundImage: "url('/fondo1.jpg')" }}>
      ...
      <form className="relative bg-white rounded-3xl flex flex-col p-0 w-[90%] max-w-[33.75rem] h-[40rem] shadow-lg font-[Montserrat] items-start py-10 px-8" onSubmit={handleSubmit}>
